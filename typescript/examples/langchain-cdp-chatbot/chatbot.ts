...
function isEvmWalletProvider(
  walletProvider: CdpServerWalletProvider,
): walletProvider is CdpServerWalletProvider {
  return walletProvider instanceof CdpServerWalletProvider;
}
...
async function initializeAgent() {
  try {
    ...
    const walletProvider = await CdpServerWalletProvider.configureWithWallet(cdpWalletConfig);
