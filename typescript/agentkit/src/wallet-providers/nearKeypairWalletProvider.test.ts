...
describe("Near Keypair Wallet", () => {
  const privateKey =
    "ed25519:4PqsZQyshimjoyHu9vHCQVb3GpFLXKUd5hx4RXrw6q8nbnEDR5repFcP58BEzYWgeA3VjsmuqToRRCmpWFQBbE7n";
  ...
  beforeEach(() => {
    ...
    wallet = new NearKeypairWalletProvider(keypair, accountId, rpcUrl, networkId);
  });
