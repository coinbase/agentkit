...
// Response example:
{
  ...
  "facilitators": [
    ...
    { "name": "solvador", "url": "https://api.solvador.com", "type": "known" },
...
```typescript
{
  facilitator: "cdp",             // Optional: 'cdp', 'payai', 'solvador', or a registered custom name
                                   // Default: "cdp"
...
The provider supports EVM, NEAR, and SVM (Solana) wallets for signing payment transactions.
...
- `@x402/near` - For NEAR payment scheme support
