...
describe("NearActionProvider", () => {
    ...
    beforeEach(() => {
        mockWallet = {
            ...
            getConnection: jest.fn().mockReturnValue(new Connection(
    ...
    describe("getCrossChainAddress", () => {
        it("should return the crosschain address when using default values", async () => {
            ...
            expect(response).toEqual("Generated cross chain address of type evm for account id wallet.near, network near-mainnet and derivation path account-1 is 0x5cf7ac588d5cdb35d8a9ed3d884f1a4245338db7");
        });
        ...
        it("should return the crosschain address when using defined values", async () => {
            ...
            expect(response).toEqual("Generated cross chain address of type evm for account id omnitester.near, network near-mainnet and derivation path account-1 is 0x9ee8197e1a04cc53ee976894082449d2f450ae34");
        });
    })
    ...
    describe("getCrossChainPublicKey", () => {
        it("should return the crosschain public key when using default values", async () => {
            ...
            const expectedMessagePart = "Computed public key for account id wallet.near, network near-mainnet and derivation path account-1 is";
            const expectedPublicKey = "04360c67764d827f09b08e8749eb4d7362ca825176f9d67c233b63aff64f4a6b947aee76cda76f1645952ed6e259bb270a76853da16d2601e4bf2e0c60b852c66d";
        ...
        it("should return the crosschain public key when using defined values", async () => {
            ...
            const expectedMessagePart = "Computed public key for account id omnitester.near, network near-mainnet and derivation path account-1 is";
            const expectedPublicKey = "0494da94af0a6b62a8d247e4a7915018cb5ce069bd2e81f90cf6b8351f8d34645ca78cfafdaeb2b1879f2501581500899de03a3b8b4f345278525206b21eaa8735";
    ...
    describe("signPayload", () => {
        ...
        it("should sign a payload when passing non mandatory fields", async () => {
            ...
            expect(response).toEqual(`The signature result is big_r: ${big_r}, big_s: ${big_s} and recovery_id: ${recoveryId}`);
        });
