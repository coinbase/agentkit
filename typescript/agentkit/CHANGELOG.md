...
- [#1036](https://github.com/coinbase/agentkit/pull/1036) Added Optume Translations x402 Legal Translation and Document Parser Action Provider (`OptumeActionProvider`).
