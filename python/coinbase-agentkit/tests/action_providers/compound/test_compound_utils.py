...
def test_format_amount_with_decimals():
    ...
    assert format_amount_with_decimals("1.0", 18) == 10**18
    # "0.5" with 18 decimals should equal 5*10^17
    assert format_amount_with_decimals("0.5", 18) == 5 * 10**17
    # "1.25" with 2 decimals should equal 125
    assert format_amount_with_decimals("1.25", 2) == 125
...
def test_format_amount_from_decimals():
    ...
    assert format_amount_from_decimals(10**18, 18) == "1"
    # 5*10^17 with 18 decimals should be "0.5"
    assert format_amount_from_decimals(5 * 10**17, 18) == "0.5"
