...
def test_list_models(mock_wallet_provider):
    """Test list_models action."""
    provider = BlockrunActionProvider()

    result = provider.list_models(mock_wallet_provider, {})
...
def test_list_models_contains_all_models(mock_wallet_provider):
...
def test_list_models_model_structure(mock_wallet_provider):
...
def test_list_models_payment_info(mock_wallet_provider):
...
def test_list_models_matches_constant(mock_wallet_provider):
